...
2. [BESLOTEN 23-8: doorgevoerd in herziene vorm — leverancierskosten-trigger, beëindiging 2 mnd / prijsaanpassing 1 mnd, wijzigen blijft vrij via 2.3] Nieuw 2.4: onderdelen van de dienst wijzigen/beëindigen als een databron (TecDoc, HaynesPro, RDW) wegvalt of zijn voorwaarden wijzigt, met evenredige vergoedingsaanpassing en zonder ontbindingsrecht voor het overige.

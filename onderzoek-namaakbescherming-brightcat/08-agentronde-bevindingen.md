...
**A3. Eigen gegevens en eigen koppeling uitzonderen in 3.2 en 3.5 (×3) — hoog.** Letterlijk zijn de eigen prijzen/orders van de klant "bedrijfsgeheim van Brightmotive" (3.2) en is de eigen ERP-koppeling verboden extractie met boete (3.5). Dit is bovendien het type beding dat art. 13 lid 5 Data Act niet-bindend maakt (beperking van eigen datagebruik) — en de eerste bres die een klant-advocaat in het bedrijfsgeheim-lid slaat.
*Fix — 3.2 toevoegen:* "Uw eigen gegevens (artikelen 3.8 en 6.5) zijn geen vertrouwelijke informatie van Brightmotive."
*Fix — 3.5 toevoegen:* "Dit geldt niet voor uw eigen gegevens (artikelen 3.8 en 6.5) en niet voor het gebruik van de koppelingen die Brightmotive daarvoor beschikbaar stelt."

**A4. Afnemers (garages) uitzonderen in 3.4 en 3.9 (×3) — hoog.** Letterlijk mag de klant zijn garages geen toegang geven (3.4 toestemmingseis; 3.9 "aan derden in gebruik geven"), terwijl 4.4 en het bedrijfsmodel dat veronderstellen. Die structureel gedoogde afwijking kleurt in een procedure de uitleg van heel 3.4 ("wordt toch niet toegepast").
*Fix — 3.4 toevoegen:* "Dit lid geldt niet voor uw afnemers die de diensten uitsluitend gebruiken om bij uw organisatie(s) te bestellen; op hen ziet artikel 1.8."
*Fix — 3.9, na "aan derden in gebruik geven":* ", met uitzondering van het gebruik door uw afnemers als bedoeld in artikel 3.4,"
...
*Fix — vervang 6.1:* "De overeenkomst gaat in op de ingangsdatum die in de overeenkomst is vermeld of, als die ontbreekt, op de dag van ondertekening door beide partijen, en heeft de in de overeenkomst vermelde looptijd of anders een looptijd van twee jaar. Implementatie, koppeling of ingebruikname is geen voorwaarde voor het ingaan van de overeenkomst of voor het verschuldigd zijn van de vergoeding."
...
*Fix — vervang 5.1:* "Behoudens in geval van opzet of bewuste roekeloosheid van de bedrijfsleiding van Brightmotive is de aansprakelijkheid van Brightmotive beperkt tot het bedrag dat u aan Brightmotive verschuldigd was over de drie maanden voorafgaand aan het moment van de schade toebrengende gebeurtenis. Een samenhangende reeks gebeurtenissen geldt als één gebeurtenis. De totale aansprakelijkheid van Brightmotive per kalenderjaar bedraagt ten hoogste het bedrag dat volgens de eerste zin geldt voor de eerste gebeurtenis in dat kalenderjaar."
...
8. 3.6 verduidelijken: "zonder daarbij de diensten, documentatie, data of vertrouwelijke informatie als model, bron of referentie te gebruiken … ook tijdens de overgangsperiode van artikel 6.4".

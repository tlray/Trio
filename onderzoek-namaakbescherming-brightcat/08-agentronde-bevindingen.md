...
*Fix — geen nieuw lid; vervang de vierde en vijfde zin van 6.5 door:* "Overige exporteerbare gegevens stellen wij op verzoek als export beschikbaar in een gangbaar, machineleesbaar formaat, bijvoorbeeld CSV. De export blijft beschikbaar tot 30 kalenderdagen na het einde van de overgangsperiode of, eindigt de overeenkomst zonder overstap, tot 30 kalenderdagen na de einddatum; daarna mogen wij de export wissen. Uw gegevens zelf wissen wij op uw verzoek."

...
> 3.6 Dit artikel beperkt niet de rechten die u op grond van dwingend recht toekomen, waaronder de artikelen 45j tot en met 45m Auteurswet, de rechten van de rechtmatige gebruiker van een databank en Verordening (EU) 2023/2854. Het raakt evenmin uw eigen gegevens (artikelen 3.8 en 6.5): die zijn geen vertrouwelijke informatie of bedrijfsgeheim van Brightmotive en u mag ze vrij gebruiken en opvragen, ook geautomatiseerd via de koppelingen die Brightmotive daarvoor beschikbaar stelt. Het staat er ook niet aan in de weg dat uw afnemers de diensten gebruiken om bij uw organisatie(s) te bestellen; voor hen gelden de gebruiksvoorwaarden van artikel 1.8. Het belet u ten slotte niet om zonder gebruik van de diensten, documentatie, data of vertrouwelijke informatie van Brightmotive zelfstandig of via derden een eigen of concurrerend systeem te (laten) ontwikkelen of af te nemen, of om met uw exporteerbare gegevens over te stappen (artikel 6.4). Ieder onderdeel van dit artikel geldt als een afzonderlijk beding.

...
- Werkinstructie overstap-aankondigingen (art. 6.4 AV): bij elke aankondiging het exportpakket klaarzetten en de termijnen bewaken (aankondiging, overgangsperiode, eventuele verlenging met opgegeven einddatum). Na de succesvolle voltooiing eindigt de overeenkomst vanzelf (art. 6.4): stuur direct de schriftelijke bevestiging en factureer, bij een einde vóór het einde van de lopende periode, de beëindigingsvergoeding over het restant. Wordt een aangekondigde overstap gestaakt, dan loopt de overeenkomst gewoon door; overweeg dan of Brightmotive zelf opzegt tegen het einde van de lopende periode (art. 6.2). Trage of steeds hervatte "migraties" zonder aantoonbare voortgang: aanschrijven op de goedetrouwverplichting van art. 27 Data Act, die ook op de klant rust.
